...
Vercel's **Root Directory must be `apps/web`** for production builds. (A NestJS backend
`apps/api` + shared `packages/shared` arrive in later migration phases — see
`docs/superpowers/plans/2026-07-09-nestjs-migration-roadmap.md`.)
